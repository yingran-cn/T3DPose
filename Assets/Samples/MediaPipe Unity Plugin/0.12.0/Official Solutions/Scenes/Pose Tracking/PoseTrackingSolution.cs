...
namespace Mediapipe.Unity.PoseTracking
{
    public class PoseTrackingSolution : ImageSourceSolution<PoseTrackingGraph>
    {
        ...
        private void Update()
        {
            if (WorldLandmarks.TryDequeue(out poseWorldLandmarks))
            {
                GlobalPoseEvent.OnPoseWorldLandmarksOutputEvent(poseWorldLandmarks);
            }
        }

        public static Detection poseDetection = null;
        public static NormalizedLandmarkList poseLandmarks = null;
        public static LandmarkList poseWorldLandmarks = null;
        public static ImageFrame segmentationMask = null;
        public static NormalizedRect roiFromLandmarks = null;

        public static Queue<LandmarkList> WorldLandmarks = new Queue<LandmarkList>();
        ...
        private void OnPoseWorldLandmarksOutput(object stream, OutputEventArgs<LandmarkList> eventArgs)
        {
            ...
            WorldLandmarks.Enqueue(eventArgs.value);
        }
